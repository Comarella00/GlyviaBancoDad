...
public interface GlicemiaRepository extends JpaRepository<Glicemia, Long> {
    ...
    Optional<Glicemia> findTopByUsuarioIdOrderByDataGlicemiaDescHoraGlicemiaDesc(Long idUsuario);
    List<Glicemia> findByUsuarioIdAndDataGlicemia(Long idUsuario, LocalDate data);
}
